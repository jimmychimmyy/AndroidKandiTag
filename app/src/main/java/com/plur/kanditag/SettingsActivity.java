 ...
 */
public class SettingsActivity extends Activity implements ColorPickerDialog.ColorPickerListener {
    ...
    private final P2PKitStatusCallback mStatusCallback = new P2PKitStatusCallback() {
        ...
        public void onEnabled() {
            logToView("Successfully enabled P2P Services, with node id: " + P2PKitClient.getInstance(SettingsActivity.this).getNodeId().toString());
        ...
        public void onError(StatusResult statusResult) {
            ...
            StatusResultHandling.showAlertDialogForStatusError(SettingsActivity.this, statusResult);
        }
    };
    ...
    private final GeoListener mGeoDiscoveryListener = new GeoListener() {
        ...
        public void onPeerDiscovered(final UUID nodeId) {
            ...
            try {
                P2PKitClient.getInstance(SettingsActivity.this).getMessageServices().sendMessage(nodeId, "SimpleChatMessage", "From Android: Hello GEO!".getBytes());
